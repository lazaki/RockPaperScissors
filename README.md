...
app/                    --> all of the source files for the application
  ...
  startGame/                --> the startGame view template and logic
    startGame.html            --> the partial template
    startGame.js              --> the controller logic
    startGame_test.js         --> tests of the controller
  playGame/                --> the playGame view template and logic
    playGame.html            --> the partial template
    playGame.js              --> the controller logic
    playGame_test.js         --> tests of the controller
